    ...
    <script src="{{ asset('backend/assets/js/pages/sweet-alerts.init.js') }}" aria-hidden="true"></script>
    <script src="{{ asset('backend/assets/libs/sweetalert2/sweetalert2.all.min.js') }}" aria-hidden="true"></script>
